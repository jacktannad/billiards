...
<template>
  <div class="vertical-tags-layout" :class="{'collapse-aside': isCollapse }">
    <aside>
      <LibLogoTitle @goHome="goHome"/>
      <LibAsideVerticalTags :collapseMenu="true" :isCollapse="isCollapse" :menu="menus"></LibAsideVerticalTags>
    </aside>
    <main>
      <header>
        <div class="left-nav">
